...
function entries(obj) {
  ...
  // loop through the object (looping through with the key)
  for (const key in obj) {
    // ^console.log(key); SHOWS US THE KEY ITTERATION...
    // define new inner array
    let innerArray = [];
  ...
  //resturn the result - aka the new object
  return newObject;
}
